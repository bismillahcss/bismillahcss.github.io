...
export default function sitemap(): MetadataRoute.Sitemap {
    ...
    const routes = [
        ...
        '/playground',
        '/tailwind-utilities',
        '/bismillahcss-htmls/bismillah-show-case.html',
        '/bismillahcss-htmls/bismillah-utilities.html',
        '/bismillahcss-htmls/neon-bismillah.html',
        '/bismillahcss-htmls/bismillahcss--semi.html',
        '/bismillahcss-htmls/bismillahcss-demo.html',
    ];
